...
# 1.3 Почему количество документов меньше количества вхождений? Ответ: в одном доументе может слово может встречаься несколько раз
```
### 2. IPM
...
```
# 7.1 Прилагательные: багровой,  Белая, алый
```
